...
class CreateSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('settings', function (Blueprint $table) {
            $table->id();
            $table->string('site_title_jp')->nullable();
            $table->string('site_title_en')->nullable();
            $table->string('site_title_vi')->nullable();
           
            $table->string('site_desc_en')->nullable();
            $table->string('site_desc_vi')->nullable();
            $table->string('site_desc_jp')->nullable();

            $table->text('site_keywords_en')->nullable();
            $table->text('site_keywords_jp')->nullable();
            $table->text('site_keywords_vi')->nullable();
            ...
            $table->string('contact_t1_jp')->nullable();
            $table->string('contact_t1_en')->nullable();
            $table->string('contact_t1_vi')->nullable();
            ...
            $table->string('contact_t7_vi')->nullable();
            $table->string('contact_t7_en')->nullable();
            $table->string('contact_t7_jp')->nullable();

            $table->string('style_logo_jp')->nullable();
