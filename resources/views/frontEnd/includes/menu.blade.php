                ...
                @foreach($HeaderMenuLinks as $HeaderMenuLink)
                    ...
                    @if($HeaderMenuLink->type==3)
                        ...
                        <li class="dropdown">
                            ...
                            @if(isset($HeaderMenuLink->webmasterSection->sections) && count($HeaderMenuLink->webmasterSection->sections) >0)
                            ...
                            @elseif(isset($HeaderMenuLink->webmasterSection->topics) && count($HeaderMenuLink->webmasterSection->topics) >0)
                                {{--topics drop down--}}
                                <ul class="dropdown-menu">
