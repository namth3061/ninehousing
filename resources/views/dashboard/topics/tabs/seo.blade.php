                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group hide">
                                    <div>
                                        ...
                                        {!! Form::text('seo_url_slug_'.@$ActiveLanguage->code,$Topics->{'seo_url_slug_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_url_slug_'.@$ActiveLanguage->code, 'dir'=>@$ActiveLanguage->direction)) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        {!! Form::textarea('seo_description_'.@$ActiveLanguage->code,$Topics->{'seo_description_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_description_'.@$ActiveLanguage->code,'maxlength'=>'165', 'dir'=>@$ActiveLanguage->direction,'rows'=>'2')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        {!! Form::textarea('seo_keywords_'.@$ActiveLanguage->code,$Topics->{'seo_keywords_'.@$ActiveLanguage->code}, array('class' => 'form-control','id'=>'seo_keywords_'.@$ActiveLanguage->code, 'dir'=>@$ActiveLanguage->direction,'rows'=>'2')) !!}
                                    </div>
                                </div>
                                <br>
                                <br>
