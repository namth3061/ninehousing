    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                ...
                @if(in_array($WebmasterBanner->type, [0, 1]))
                    <?php
                    $ttile = "bannerPhoto";
                    $file_name = "file_";
                    $file_allow = "image/*";
                    ...
                    <div class="form-group row hide">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                {!! Form::text('icon','fa-angle-double-down', array('placeholder' => '','class' => 'form-control icp icp-auto','id'=>'icon', 'data-placement'=>'bottomRight')) !!}
